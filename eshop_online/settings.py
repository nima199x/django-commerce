...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-sj&(jaf5(_s1)7go!ejh!@wt4q^f)b$9tlq#f-uabajn*)*k+d')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'eshop_online'),
...
# Security settings - only enforced when DEBUG is False (production)
if not DEBUG:
